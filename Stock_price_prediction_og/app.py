...
@app.route('/market-news.html')
def market_news():
    """Endpoint to serve market news page"""
    return render_template('market-news.html')

@app.route('/watchlist')
@app.route('/watchlist.html')
def watchlist():
    """Endpoint to serve watchlist page"""
    return render_template('watchlist.html')

@app.route('/portfolio')
@app.route('/portfolio.html')
def portfolio():
    """Endpoint to serve portfolio page"""
...
def predict():
    try:
        ...
        response = {
            ...
            'buy_sell_explanation': f"Suggested Buy Price: {buy_price} , Suggested Sell Price: {sell_price}"
        }
